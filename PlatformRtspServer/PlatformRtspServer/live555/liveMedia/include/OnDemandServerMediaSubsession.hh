...
protected: // redefined virtual functions
  ...
  virtual void getStreamParameters(unsigned clientSessionId,
				   ...
				   u_int8_t& destinationTTL,
                                   ...
                                   Port& serverRTCPPort,
								   void*& streamToken,
								   TlsHelperObj tlsSock = TlsHelperObjNull);
...
public:
  ...
  Destinations(int tcpSockNum, unsigned char rtpChanId, unsigned char rtcpChanId, TlsHelperObj tlsSock = TlsHelperObjNull)
    : isTCP(True), rtpPort(0) /*dummy*/, rtcpPort(0) /*dummy*/,
      tcpSocketNum(tcpSockNum), rtpChannelId(rtpChanId), rtcpChannelId(rtcpChanId), tlsSocket(tlsSock) {
  }
