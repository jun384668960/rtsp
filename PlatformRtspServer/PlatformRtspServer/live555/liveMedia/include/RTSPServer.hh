...
public: // should be protected, but some old compilers complain otherwise
  ...
  protected:
    RTSPClientConnection(RTSPServer& ourServer, int clientSocket, struct sockaddr_in clientAddr,Boolean supportTls = False);
...
protected: // redefined virtual functions
  ...
  virtual ClientConnection* createNewClientConnection(int clientSocket, struct sockaddr_in clientAddr, int serverSocket = 0);
