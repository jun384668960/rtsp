...
::lookupServerMediaSession(char const* streamName, Boolean isFirstLookupInSession) {
  ...
  printf("DynamicRTSPServer lookupServerMediaSession start look\n");
  ServerMediaSession* sms = RTSPServer::lookupServerMediaSession(streamName);
  Boolean smsExists = sms != NULL;

  printf("fileExists = %d,smsExists = %d, isFirstLookupInSession = %d\n",fileExists, smsExists,isFirstLookupInSession);
  ...
  if (!fileExists) {
    ...
    if (sms == NULL) {
      printf("createNewSMS streamName = %s, fid = %p\n",streamName, fid); 
