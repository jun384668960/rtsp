...
int main(int argc, char** argv) {
  ...
  *env << "LIVE555 Proxy Server\n"
  ...
  // port numbers (443 and 8000 and 8080).

  if (rtspServer->setUpTunnelingOverHTTP(443) || rtspServer->setUpTunnelingOverHTTP(80) || rtspServer->setUpTunnelingOverHTTP(8000) || rtspServer->setUpTunnelingOverHTTP(8080)) {
