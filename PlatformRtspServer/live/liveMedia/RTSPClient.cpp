...
//    printf("rtspclient sendRequest: sock = %d,cmd = %s\n",fOutputSocketNum,cmd);
...
//    printf("rtspclient handleIncomingRequest: sock = %d,tmpBuf = %s\n",fOutputSocketNum,tmpBuf);
  }
}
...
//  printf("rtspclient icomingdatahandle1 bytesread = %d,sock = %d, buffer:%s\n",bytesRead,fInputSocketNum,(char*)&fResponseBuffer[fResponseBytesAlreadySeen]);
