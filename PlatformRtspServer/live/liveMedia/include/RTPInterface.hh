...
public:
  tcpStreamRecord(int streamSocketNum, unsigned char streamChannelId,
		  tcpStreamRecord* next,TlsHelperObj tlsSocket = TlsHelperObjNull);
...
public:
  ...
  void addStreamSocket(int sockNum, unsigned char streamChannelId, TlsHelperObj tlsSock = TlsHelperObjNull);
...
private:
  ...
  Boolean sendRTPorRTCPPacketOverTCP(unsigned char* packet, unsigned packetSize,
				     int socketNum, unsigned char streamChannelId, TlsHelperObj tlsSock = TlsHelperObjNull);
  Boolean sendDataOverTCP(int socketNum, u_int8_t const* data, unsigned dataSize, Boolean forceSendToSucceed, TlsHelperObj tlsSock = TlsHelperObjNull);
...
private:
  ...
  TlsHelperObj fNextTcpTlsReadStreamSocketNum;
